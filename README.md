...
**Assistants**: Viktoria Ivaan and Pat Sessford
...
General Assembly's Data Science part time materials are organised into **four** units.

| Unit   | Title  | Topics Covered  | Length |
| ---    | ---    |  ---     | ---    |
| Unit 1 | Data Foundations               | Python Syntax, Development Environment | Lessons 1-4 |
| Unit 2 | Working with Data              | Stats Review, Visualisation, & EDA     | Lessons 5-9  |
| Unit 3 | Data Science Modelling          | Regression, Classification, & KNN      | Lessons 10-14  |
...
FLEX: APIs and web scraping            | Unit 1 | Session 4 |
--- | ---  | ---  |
Exploratory Data Analysis in Pandas     | Unit 2 | Session 5 |
Data Visualisation in Python            | Unit 2 | Session 6 |
...
This course will ask you to complete a project in order to practice and apply the skills covered in-class.
...
This is an opportunity for you to demonstrate your new skills and tackle a pressing issue relevant to your life, industry, or organisation. You’ll create a hypothesis, analyse internal data, and generate a working model, prototype, solution, or recommendation.
...
To make sure you and the other students get the most out of this course, we expect you to arrive on time for class (we'll be starting promptly at 6pm) and to let us know via Slack if you'll be late.

Homework or exercises for you to complete won't be marked or graded, but we're more than happy to take a look over your code and give you pointers and tips if you'd like.
...
Slack any of us to reserve a time-slot!
